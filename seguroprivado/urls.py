...
urlpatterns = [
    ...
    path('citas_medico/actuales/cita/<int:pk>/',views.RealizaCitasView.as_view(), name="form_realizar_citas"),
    path('citas_medico/buscar/',views.FiltroCitaView.as_view(),name="filtro_citas"),
